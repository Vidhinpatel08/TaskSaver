                ...
                <div className="">
                    <div className='bg-violet-100 lg:w-[50%] md:w-[60%] sm:w-[80%] w-[95%] m-auto flex justify-center min-h-[85vh] rounded-xl'>
                        <div className="taskAdd w-full ">
                            <h1 className='text-3xl w-fit m-auto font-bold my-2 font-[math] text-opacity-75 flex items-center justify-center'>TaskSaver - Manage your todos at one place</h1>
                            <div className="your-task w-[95%] m-auto my-5 ">
                                <h2 className='text-[30px] font-bold text-center font-[math]'>Your Todos</h2>
                                <div>{Object.entries(groupedTodos).map(([date, todos]) => (
                                    <div key={date}>
                                        <div className="mainTodosDisplay my-10">
